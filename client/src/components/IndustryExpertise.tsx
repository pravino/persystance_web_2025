...
export default function IndustryExpertise() {
  const industries = [
    ...
    },
    {
      ...
      description: "White-label exchange development with institutional custody (Fireblocks). Built Nexus Trading with high-performance matching engine, real-time ledger, and B2B connectivity to major exchange networks.",
    },
    {
