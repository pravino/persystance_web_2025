...
export default function SEO({
  ...
  keywords = "MVP development, rapid prototyping, startup development, 2 week MVP, white label exchange, crypto exchange development, trading platform, Fireblocks integration, institutional trading, Telegram games, Web3 games, blockchain gaming, GDPR compliance, ISO 27001, KYC AML compliance, asset management systems",
  hreflang = true,
}: SEOProps) {
